      ...
      <TwicWrapper filename="pages/short-videos.vue">
        <TwicAbstract title="Short Videos">
          ...
          <p>
            ...
            <a
              href="https://www.twicpics.com/docs/topics/video-optimization#video-slicing?utm_source=github&utm_medium=organic&utm_campaign=components#vue3"
              target="_blank"
              rel="noreferrer"
            >
          ...
          <ul>
            ...
            <li>
              ...
              <span>
                allows to perfom
                <a
                  href="https://www.twicpics.com/docs/reference/transformations?utm_source=github&utm_medium=organic&utm_campaign=components#vue3"
                  target="_blank"
                  rel="noreferrer"
                >
