<template>
  <div>
    <TwicWrapper filename="src/views/TwicCritical.vue">
      ...
      <TwicAbstract title="Critical Image with Art Direction" class="mt">
        <p>
          <Code>TwicPicture</Code> stands out as a robust and efficient
          solution for optimizing the <b>Largest Contentful Paint</b> (LCP)
          images in web projects.
        </p>
        <p>
          ...
          and dynamically generates <Code>source</Code> elements and
          <Code>srcset</Code> attributes from a
